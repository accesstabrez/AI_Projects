...
def analyse(file):
    ...
    question = """Take this bpmn file content and generate a mermaid code. Mke sure to have start and end nodes. Remove any apostrophes from the mermaid file. Use the following example:
     graph TD
